...
"#]]
        ...
        assert_eq!(
            ...
            "independent branches can't currently be created in this kind of workspace - need a base. \
             The reserved ref on a plain commit is an ad-hoc view now that project metadata no \
             longer lives on the workspace: nothing declares it a workspace, so it is anonymous."
        );
